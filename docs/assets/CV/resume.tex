...
6823 St. Charles Avenue & \href{mailto:dferranti@tulane.edu}{dferranti@tulane.edu}\\ 
Tulane University,      & \texttt{Website} \\
  New Orleans, Louisiana 70118    & \url{djferranti.github.io}
\end{tabular}
%% ==============================================================
\vspace{0.1in}
...
\begin{outerlist}
\item Computational methods for low Reynolds number fluid dynamics.
\item Emergence of sychronization in fluid-solid body interactions.
\end{outerlist}
% section research_backg (end)
%% =========  ==============================
\vspace{0.1in}
\section{Education}
    \textbf{Tulane University}, New Orleans, LA \hfill 2017--2023 (expected)
    \begin{outerlist}
        \item PhD in Mathematics department. 
...
\vspace{-0.25in}
\begin{outerlist}
\item {\bf Tulane University} \hfill 2017-present \\
  Center for Computational Science in Mathematics Department.
  \begin{innerlist}
    \item Extending the method of regularized stokeslets by using exact integration over triangulated surfaces. Using minimal models of interacting bodies in viscous flows to study the dynamical differences that arise in models that incorporate weak inertia versus those that assume the fluid inertia is negligible.
  \end{innerlist}
...
\textbf{As instructor}
\begin{outerlist}
  \item Probability \& Statistics I (Math 1110). \hfill Spring 2023 \\ \textit{Elementary probability theory and statistics}
  \item Introduction to Applied Math (Math 2240). \hfill Fall 2021 \\ \textit{Ordinary differential equations for engineers/physicists}
  \end{outerlist}
  \vspace{0.5em}
...
\item Member of Inclusivity in Mathematics Task Force at Tulane (IMTF) \hfill 2020-present
\end{outerlist}
...
\item Math for All in New Orleans (2020 and 2021)
